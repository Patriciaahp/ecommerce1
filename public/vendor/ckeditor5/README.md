...
```bash
npm install --save @ckeditor/ckeditor5-build-classic-build-classic
```
...
```js
import ClassicEditor from '@ckeditor/ckeditor5-build-classic-build-classic';

// Or using the CommonJS version:
// const ClassicEditor = require( '@ckeditor/ckeditor5-build-classic-build-classic' );
