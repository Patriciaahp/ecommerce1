<x-admin-layout>
    <div class="container-menu py-12">
        <section class="grid grid-cols-5 gap-6 text-white">
            <a href="{{ route('admin.orders.index') . '?status=1' }}" class="bg-red-500 bg-opacity-75 rounded-lg px-12
            pt-8 pb-4">
            ...
            <a href="{{ route('admin.orders.index') . '?status=2' }}" class="bg-gray-500 bg-opacity-75 rounded-lg px-12
            pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $ordersByStatus[2] }}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . '?status=3' }}" class="bg-yellow-500 bg-opacity-75 rounded-lg
            px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $ordersByStatus[3] }}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . '?status=4' }}" class="bg-pink-500 bg-opacity-75 rounded-lg px-12
            pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $ordersByStatus[4] }}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . '?status=5' }}" class="bg-green-500 bg-opacity-75 rounded-lg
            px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $ordersByStatus[5] }}
                </p>
        ...
        <section class="bg-white shadow-lg rounded-lg px-12 py-8 mt-12 text-gray-700">
            ...
            <ul>
                @foreach ($orders as $order)
                    <li>
                        <a href="{{ route('admin.orders.show', $order) }}" class="flex items-center py-2 px-4
                        hover:bg-gray-100">
