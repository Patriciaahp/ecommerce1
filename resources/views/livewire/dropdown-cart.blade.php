...
red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">{{ Cart::count() }}</span>
        ...
        <x-slot name="content">
            <ul>
                        ...
                        <article class="flex-1">
                            ...
                            <div class="flex">
                                ...
                                @isset($item->options['color'])
                                    <p class="mx-2">_Color:{{__(ucfirst($item->options['color']))}}</p>
                                @endisset
                ...
                @empty
                    <li class="py-6 px-4"><p class="text-center text-gray-700">
            ...
            @if(Cart::count())
                <div class="px-3 py-2" >
                    <p class="text-lg text-gray-700 mt-2 mb-3"><span class="font-bold">Total:</span> {{ Cart::subtotal()
                     }} &euro;</p>
